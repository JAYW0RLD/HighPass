...
-- 1. Add prepaid balance to wallets
ALTER TABLE wallets 
ADD COLUMN IF NOT EXISTS prepaid_balance_wei TEXT DEFAULT '0';

CREATE INDEX IF NOT EXISTS idx_wallets_prepaid 
ON wallets(prepaid_balance_wei);

-- 2. Create reputation history table
CREATE TABLE IF NOT EXISTS reputation_history (
  agent_id TEXT PRIMARY KEY,
  internal_score REAL DEFAULT 0,        -- CRO 단위
  total_payments_cro REAL DEFAULT 0,    -- 누적 결제액
  total_deposits_cro REAL DEFAULT 0,    -- 누적 입금액
